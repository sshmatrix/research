...
\begin{multicols}{2}
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=75mm]{./img/complexPeriods.png}\vspace{1mm}
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=75mm]{./img/complexTorus.png}\vspace{1mm}
		\captionof{figure}{\textls[-50]{\mono{Parameterisation of a complex lattice generated by a bi-periodic function}}}
		\label{fig:ec}
	\end{minipage}
\end{multicols}
\begin{flushleft} 
