...
\begin{flushleft}
  ...
  \vspace{2mm}
  \begin{center}
    F($\bar{\text{x}}$) = F($\bar{\text{x}}$ + n\textsubscript{1}\,\cdot\,$\hat{\upomega}$\textsubscript{1}) = F($\bar{\text{x}}$ + n\textsubscript{2}\,\cdot\,$\hat{\upomega}$\textsubscript{2}),
  \end{center}
  \begin{flushright}
    {\vspace{-7mm}\mono{(9)}}
  \end{flushright}
...
\begin{flushleft}
  ...
  \begin{center}
    \resizebox{12px}{5.5px}{\kalam\textls[0]{sn}}\,\resizebox{6px}{5.2px}{\upmu} = $\displaystyle\frac{\;\;\text{x'}}{{\text{\upalpha}}}$, \resizebox{12px}{5.5px}{\kalam\textls[0]{cn}}\,\resizebox{6px}{5.2px}{\upmu} = $\displaystyle\frac{\;\;\text{y'}}{{\text{\upgamma}}}$, \resizebox{12.35px}{8.5px}{\kalam\textls[0]{dn}}\,\resizebox{6px}{5.2px}{\upmu} = $\displaystyle\frac{\text{1}}{{\text{r(\uptheta)}}}$.
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(10)}}
  \end{flushright}
  \vspace{2mm}
  There are two main differences to note: first is the appearance of a third trigonometric function \resizebox{12.35px}{8.5px}{\kalam\textls[0]{dn}} capturing the curvature of the path, and second is the change in argument from {\uptheta} to \resizebox{6px}{5.2px}{\upmu}. For the particular case of an elliptical path, \resizebox{6px}{5.2px}{\upmu} can be evaluated by considering equation (8) along with the implied equivalence to equation (5) such that
  \begin{center}
    \resizebox{6px}{5.2px}{\upmu}\;\;\equiv\;\;F(e,\,\raisebox{0.25mm}{\resizebox{7.5px}{5px}{\upvarphi}}) = \,{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\footnotesize{\hspace{-0.10mm}{\upvarphi}}}}}{\hspace{-3mm}\textsubscript{\raisebox{-2.5mm}{\hspace{-0.15mm}\footnotesize{0}}}}\;r(\uptheta,\,e)\,{\resizebox{5px}{7px}{\updelta}}{\uptheta}, where
  \end{center}
  \begin{center}
  ...
  \end{flushright}
  \vspace{2mm}
  Note that \resizebox{6px}{5.2px}{\upmu} is the (re)definition of the argument of Jacobi's trigonometric functions and \resizebox{6px}{5.2px}{\upmu} = {\uptheta} for a circle. Similarly, \resizebox{12px}{5.5px}{\kalam\textls[0]{sn}} = sine, \resizebox{12px}{5.5px}{\kalam\textls[0]{cn}} = cosine and \resizebox{12.35px}{8.5px}{\kalam\textls[0]{dn}} = 1/r for a circle. Jacobi noted that the trajectory (aka topology) of an ellipse is completely described by two concentric circles that inscribe (radius \raisebox{0.25mm}{\resizebox{6.5px}{5px}{\upgamma}} = 1) and circumscribe (radius {\resizebox{7.25px}{5.3px}{\upalpha}}) the ellipse, and Jacobi's trigonomatric functions capture the projection of the ellipse (encased by the two circles) onto these two circles; these two circles is some sense form the basis of the elliptical topology. This geometric interpretation of Jacobi's functions is shown in figures \ref{fig:jacobi} and \ref{fig:dual}. \linebreak\linebreak
  }}
\end{flushleft}
\begin{multicols}{2}
  \noindent
