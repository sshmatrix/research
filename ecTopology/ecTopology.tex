...
\end{multicols}
\begin{flushleft}
  \textls[-50]{\mono{We may now revisit Jacobi's \resizebox{12px}{5.5px}{\kalam\textls[0]{sn}}\textsuperscript{-1}${\text{x}}$ function and understand how its topology allows for strict bi-periodicity. Jacobi's motivation behind \resizebox{12px}{5.5px}{\kalam\textls[0]{sn}}\textsuperscript{-1}${\text{x}}$ function was purely geometric much as the motivation behind sine and cosine functions is the coordinate transformation (x, y) = ({\large\pala\it{f}}\hspace{0.4mm}, {\large\pala\it{f}}\hspace{0.2mm}'\hspace{-1mm}) {\rightarrow} (sin{\,\uptheta}, cos{\,\uptheta}). Jacobi noted that the trajectory (aka topology) of an ellipse is completely described by two concentric circles that inscribe (radius \raisebox{0.25mm}{\resizebox{6.5px}{5px}{\upgamma}} = 1) and circumscribe (radius {\resizebox{7.25px}{5.3px}{\upalpha}}) the ellipse. Consider equation (8) for a generic final angle other than {\resizebox{5.5px}{5.5px}{\uppi}/2} such that
	\begin{center}
    \resizebox{6.5px}{5.5px}{\upmu}\;\;\equiv\;\;C(e,\,\raisebox{0.25mm}{\resizebox{7.5px}{5px}{\upvarphi}}) = \,{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\footnotesize{\hspace{-0.10mm}{\upvarphi}}}}}{\hspace{-3mm}\textsubscript{\raisebox{-2.5mm}{\hspace{-0.15mm}\footnotesize{0}}}}\;$\displaystyle\frac{\text{1}}{\text{(1 - e\textsuperscript{2}sin\textsuperscript{2}{\uptheta})\textsuperscript{1/2}}}$\,{\resizebox{5px}{7px}{\updelta}}{\uptheta}
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(10)}}
  \end{flushright}
  \vspace{2mm}
   While studying the geometry of this trajectory, Jacobi arrived at his description of \resizebox{12px}{5.5px}{\kalam\textls[0]{sn}}\textsuperscript{-1}${\text{x}}$ function as shown in figures \ref{fig:jacobi} and \ref{fig:dual}.\linebreak\linebreak
   }}
\end{flushleft}
\begin{multicols}{2}
  \noindent
  \begin{minipage}{\linewidth}
    ...
    \captionof{figure}{\textls[-50]{\mono{Jacobi's trigonometric functions}}}
    \label{fig:jacobi}
  \end{minipage}
  \noindent
  \begin{minipage}{\linewidth}
