...
\begin{flushleft}
  ...
  \vspace{2mm}
  \begin{center}
    C(e) = 4\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\scriptsize{\upalpha}}}}{\hspace{-2.75mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;({\updelta}x\textsuperscript{2} + {\updelta}y\textsuperscript{2})\textsuperscript{1/2} = 4\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\scriptsize{\upalpha}}}}{\hspace{-2.75mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;\Big[$\displaystyle\frac{\text{1 - e\textsuperscript{2}x\textsuperscript{2}}}{\text{1 - x\textsuperscript{2}}}$\Big]\textsuperscript{\textsuperscript{\scriptsize{1/2}}}\,{\updelta}x.
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(2)}}
  \end{flushright}
  \vspace{1.85mm}
  This is already the {\mbold{elliptic integral}} of the second kind{\textsuperscript{\textcolor{blue}{2}}\blfootnote{\textls[-50]{\mono{\textsuperscript{2}{'second kind' due to the presence of {\uptheta} in the numerator in its parameterised form; 'first kind' has 1 in the numerator}}}}} and it is particularly difficult to evaluate analytically. When e = 1 (i.e. straight lines; k = 0), it is straightforward and evaluates to 4$\text{\upalpha}$ as expected. When e = 0 (i.e. circles; k = 1), it is also relatively straightforward and evaluates naturally to
  \vspace{1mm}
  \begin{center}
    C(e)\textsubscript{k\,=\,1} = 4\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\scriptsize{\upalpha}}}}{\hspace{-2.75mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;$\displaystyle\frac{\text{1}}{\text{(1 - x\textsuperscript{2})\textsuperscript{1/2}}}$\,{\updelta}x = 4\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\scriptsize{\upalpha}}}}{\hspace{-2.75mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;sin\textsuperscript{-1}(x) = 2\hspace{0.2mm}{\uppi}\hspace{0.2mm}\upalpha.
  \end{center}
  \begin{flushright}
    {\vspace{-9mm}\mono{(2a)}}
  \end{flushright}
  ...
  \vspace{1.85mm}
  \begin{center}
    C(e) = 4\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.75mm}{\scriptsize{\uppi/2}}}}{\hspace{-5.25mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;\;(1 - e\textsuperscript{2}sin\textsuperscript{2}{\uptheta})\textsuperscript{1/2}\,{\updelta}{\uptheta}.
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(3)}}
  \end{flushright}
  ...
  \vspace{1mm}
  \begin{center}
    C(k) = $\displaystyle\frac{\text{1}}{\text{2}}$\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\footnotesize{1}}}}{\hspace{-2.5mm}\textsubscript{\raisebox{-2.5mm}{\small{k}\textsuperscript{\scriptsize{2}}}}}$\displaystyle\frac{\text{{\uptheta}}}{\text{[\uptheta({\uptheta} - k\textsuperscript{2})({\uptheta} - 1)]}\textsuperscript{\textsuperscript{\scriptsize{1/2}}}}$\,{\updelta}{\uptheta} = $\displaystyle{-}\frac{\text{\mbold{i}}}{\text{2}}$\;{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\footnotesize{1}}}}{\hspace{-2.5mm}\textsubscript{\raisebox{-2.5mm}{\small{k}\textsuperscript{\scriptsize{2}}}}}$\displaystyle\frac{\text{{\uptheta}}}{\text{\,E(\uptheta)}}$\,{\updelta}{\uptheta},
  \end{center}
  \begin{flushright}
    {\vspace{-9mm}\mono{(4)}}
  \end{flushright}
...
\begin{flushleft}
  ...
  \textbf{\Large\pbold{\textls[0]{ABEL'S INTUITION}}}\linebreak\linebreak
  ...
  \vspace{2mm}
  \begin{center}
    F\textsuperscript{-1}($\bar{\text{x}}$) = 1\,/\,{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\small{$\bar{\text{x}}$}}}}{\hspace{-2.5mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;$\displaystyle\frac{\text{1}}{\text{(1 - x\textsuperscript{2})\textsuperscript{1/2}}}$\,{\updelta}x = 1\,/\,sin\textsuperscript{-1}($\bar{\text{x}}$) = sin($\bar{\text{x}}$).
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(5)}}
  \end{flushright}
  \vspace{2mm}
  Abel crucially formalised the definitions of inverses of trigonometric functions using definite integrals and differential/intergal calculus developed by Newton more than 150 years prior. 
  \linebreak\linebreak\linebreak
  \textbf{\Large\pbold{\textls[0]{JACOBI'S BREAK}}}\linebreak\linebreak
  ...
  \begin{center}
    C($\bar{\text{x}}$) = 4\upalpha\,{{\raisebox{-1mm}{\huge\mate{^^^^222b}}}\textsuperscript{\raisebox{2.5mm}{\small{$\bar{\text{x}}$}}}}{\hspace{-2.5mm}\textsubscript{\raisebox{-2.5mm}{\footnotesize{0}}}}\;\;$\displaystyle\frac{\text{1}}{\text{[(1 - x\textsuperscript{2})(\text{1 - e\textsuperscript{2}x\textsuperscript{2}})]\textsuperscript{\textsuperscript{\scriptsize{1/2}}}}}$\,{\updelta}x.
  \end{center}
  \begin{flushright}
    {\vspace{-8mm}\mono{(7)}}
  \end{flushright}
