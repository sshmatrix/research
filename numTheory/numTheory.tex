...
% ------------------------------------
% fonts
\newfontfamily\pro[Path=./]{__SFPro.ttf}
...
\newfontfamily\hindi[Path=./]{__Martel.ttf}
\newfontfamily\naskh[Path=./]{__Naskh.ttf}
\newfontfamily\robot[Path=./]{__Roboto.ttf}
\newfontfamily\victr[Path=./]{__VictorMono.ttf}
\newfontfamily\starg[Path=./]{__Stargate.ttf}
