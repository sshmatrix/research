...
\begin{multicols}{2}
	...
	\begin{minipage}{\linewidth}
		...
		\captionof{figure}{\textls[-50]{\mono{Zero cross-overs p\textsubscript{k} and p\textsubscript{k}/k for k up to 44. Note: p\textsubscript{k}/k = 4 at k = 52.}}}
		\label{fig:crosses}
	\end{minipage}
	\noindent
	\begin{minipage}{\linewidth}
