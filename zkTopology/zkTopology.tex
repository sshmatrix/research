...
\begin{flushleft}
	...
	\colorbox{Gray}{\hspace{1mm}\parbox{0.99\textwidth}{\vspace{1mm}\textls[-50]{\mono{Let's take a sanity break and talk in 'normal' mathematical language. Note that in order to count to higher and higher values (more digits), Bob needs keep extending the dimensions of his 'counting box'. The 'counting volume' required to count up to {\upgamma} digits is then written as a series sum ({\seven} + {\seven\,\seven} + {\seven\,\seven\,\seven} + \cdot\cdot\cdot\;\raisebox{0.2ex}{\footnotesize{up\,to\,{\upgamma}}}\;\cdot\cdot\cdot\;+ {\seven\,\seven\,\cdot\cdot\cdot\,\raisebox{0.2ex}{\footnotesize{{\upgamma}}}\,\cdot\cdot\cdot\,\seven}). This is extremely dirty. Due to the asymmetric-by-1 nature of Bob's natural number system, many identities tend to have unnecessarily complex forms. In a whole number system however, the counting volume for {\upgamma} digits is simply ({\seven\,\seven\,\cdot\cdot\cdot\,\raisebox{0.2ex}{\footnotesize{{\upgamma}}}\,\cdot\cdot\cdot\,\seven}); this is equivalent to 10\textsuperscript{{\upgamma}} digits in the decimal system. This finally convinces Bob to accept {\zero} in his counting system, thereby formalising whole numbers as the default counting framework.\vspace{1mm}}}}}\linebreak\linebreak\linebreak\linebreak
	\linebreak
