...
\begin{flushleft}
	...
	\textls[-50]{\mono{This trapdoor feature of our chosen system is essentially the backbone of all present day cryptography.\linebreak\linebreak\linebreak
	}}
...
\begin{multicols}{2}
	...
	\begin{minipage}{\linewidth}
		...
		\captionof{figure}{\mono{Elliptic curve over a continuous infinite field, aka a Lie group. We ignore the finite field contraint in this figure for simplicity. Three examples are shown depicting how to interpret different intersections of the line with the elliptic curve and the infinity point.}}
		\label{fig:ecc0}
	\end{minipage}
	\noindent
	\begin{minipage}{\linewidth}
...
\begin{flushleft}
	...
	2. For any two points {\pbold{a}} and {\pbold{b}} on the elliptic curve, a line through them intersects the elliptic curve again at most - but not necessarily - 1 more point, denoted by {\pbold{c}}; the blue line in figure \ref{fig:ecc0} is one such example.\linebreak
	}}
