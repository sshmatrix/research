...
\begin{flushleft}
	...
	\vspace{1mm}}}}}
	\colorbox{Gray}{\hspace{1mm}\parbox{1.0\textwidth}{\vspace{1mm}\textls[-50]{\mono{captures the supercharging effect composed of large number of atomic prime factorisations. The supercharging increases the security of the resulting trapdoor but fails to increase it beyond the post-quantum regime due to being limited by the difficulty of prime factorisation problem.
